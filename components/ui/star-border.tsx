...
const StarBorder = <T extends React.ElementType = "button">({
  ...
  return (
    ...
    >
      ...
      ></div>
      <div className="relative z-1 bg-gradient-to-b from-black to-slate-900 border border-blue-950/60 text-white text-center text-[16px] py-[16px] px-[26px] rounded-[20px]">
        {children}
      </div>
    </Component>
  );
